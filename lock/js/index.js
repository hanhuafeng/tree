...
!function(global,factory){if("function"==typeof define&&define.amd)define("/Plugin/jquery-appear",["exports","jquery","Plugin"],factory);else if("undefined"!=typeof exports)factory(exports,require("jquery"),require("Plugin"));else{var mod={exports:{}};factory(mod.exports,global.jQuery,global.Plugin),global.PluginJqueryAppear=mod.exports}}(this,function(exports,_jquery,_Plugin2){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _jquery2=babelHelpers.interopRequireDefault(_jquery),_Plugin3=babelHelpers.interopRequireDefault(_Plugin2),NAME="appear",Appear=function(_Plugin){function Appear(){return babelHelpers.classCallCheck(this,Appear),babelHelpers.possibleConstructorReturn(this,(Appear.__proto__||Object.getPrototypeOf(Appear)).apply(this,arguments))}return babelHelpers.inherits(Appear,_Plugin),babelHelpers.createClass(Appear,[{key:"getName",value:function(){return NAME}},{key:"bind",value:function(){var _this2=this;this.$el.on("appear",function(){_this2.$el.hasClass("appear-no-repeat")||(_this2.$el.removeClass("invisible").addClass("animation-"+_this2.options.animate),_this2.$el.data("repeat")===!1&&_this2.$el.addClass("appear-no-repeat"))}),(0,_jquery2.default)(document).on("disappear",function(){_this2.$el.hasClass("appear-no-repeat")||_this2.$el.addClass("invisible").removeClass("animation-"+_this2.options.animate)})}},{key:"render",value:function(){_jquery2.default.fn.appear&&(this.$el.appear(this.options),this.$el.not(":appeared").addClass("invisible"),this.bind())}}]),Appear}(_Plugin3.default);_Plugin3.default.register(NAME,Appear),exports.default=Appear});METUI_FUN['head_nav_met_11_2'] = {
    ...
    load: function() {
        $('.head_nav_met_11_2-load').hide();
    },
    cntotc: function() {
        //简体繁体互换
        var b = $('.head_nav_met_11_2-sec .btn-cntotc');
...
var x = new metui(METUI_FUN['head_nav_met_11_2']);METUI_FUN['subcolumn_nav_met_11_2'] = {
    name: 'subcolumn_nav_met_11_2',
    init: function() {
        // 内页子栏目导航水平滚动
        var nav = METUI['subcolumn_nav_met_11_2'].find('.subcolumn-nav'),
            ul = METUI['subcolumn_nav_met_11_2'].find('ul'),
            li=ul.find('li'),
            dropdown = ul.find('.dropdown'),
            w=li.parentWidth(),
            uw=ul.width();
        if (ul.length && w>uw) {
            ul.navtabSwiper();nav.css('width', '100%');
            if (dropdown.length) {
...
var x = new metui(METUI_FUN['subcolumn_nav_met_11_2']);METUI_FUN['foot_nav_met_11_2'] = {
    name: 'foot_nav_met_11_2',
    weixin: function() {
        var wx = METUI['foot_nav_met_11_2'].find('#met-weixin');
        if (wx.length) {
            Breakpoints.on('xs', {
                enter: function() {
    ...
    collapse: function() {
        Breakpoints.on('xs', {
            enter: function() {
                var list = METUI['foot_nav_met_11_2'].find('.list');
...
var x = new metui(METUI_FUN['foot_nav_met_11_2']);METUI_FUN['back_top_met_11_2'] = {
...
var x = metui(METUI_FUN['back_top_met_11_2']);METUI_FUN['banner_met_11_2'] = {
    name: 'banner_met_11_2',
    init: function() {
        if (METUI['banner_met_11_2'].length) {
            var img = METUI['banner_met_11_2'].find('.cover-image').eq(0);
            img.imageloadFun(function() {
                var slide = METUI['banner_met_11_2'].find('.slick-slide'),
                ...
                Breakpoints.on('md lg', {
                    enter: function() {
                        METUI['banner_met_11_2'].find('.cover-image').height(bh[0]);
                    }
                })
                Breakpoints.on('sm', {
                    enter: function() {
                        METUI['banner_met_11_2'].find('.cover-image').height(bh[1]);
                    }
                })
                Breakpoints.on('xs', {
                    enter: function() {
                        METUI['banner_met_11_2'].find('.cover-image').height(bh[2]);
                    }
                })
                if (slide.length > 1) {
                    METUI['banner_met_11_2'].slick({
                        autoplay: true,
                        autoplaySpeed: 4000,
                        pauseOnHover: !0,
                        swipe: !0,
                    ...
                    $('.banner_met_11_2 .slick-slide .banner-text').hide();
                    $('.banner_met_11_2 .slick-slide.slick-active .banner-text').show();
                    });
                }
            })
            if (M['classnow'] == 10001) {
                Breakpoints.on('md lg', {
                    enter: function() {
                        var wallpaper = METUI['banner_met_11_2'].parent(),
                            slide = METUI['banner_met_11_2'].find('.slick-slide'),
                            track = METUI['banner_met_11_2'].find('.slick-track');
                        wallpaper.on('mousemove', function(e) {
                        ...
                        wallpaper.on('mouseleave', function() {
                            track.css({
...
var banner = metui(METUI_FUN['banner_met_11_2']);METUI_FUN['service_list_met_11_2'] = {
  name: 'service_list_met_11_2',
  init: function() {
    Breakpoints({
      xs: {
        min: 0,
    ...
    var item = METUI['service_list_met_11_2'].find('.item'),
      col = item.data('col').split('|'),
      int;
    if (col.length) {
      Breakpoints.on('xs', {
        enter: function() {
          int = 12 / col[0];
          if (parseInt(int) == int) {
            $('.service_list_met_11_2 .item:nth-child(' + int + 'n)').css('borderRight', '0');
          }
...
var x = new metui(METUI_FUN['service_list_met_11_2']);METUI_FUN['hotproduct_list_met_11_2'] = {
    name:'hotproduct_list_met_11_2',
    init: function() {

        var list=METUI['hotproduct_list_met_11_2'].find('.list');
        if(list.length){
            var rz=list.attr('data-resize').split('|'),
            num=list.data('num'),
            prev=METUI['hotproduct_list_met_11_2'].find('.control-prev'),
            next=METUI['hotproduct_list_met_11_2'].find('.control-next');
            if(rz[0]==''){
                return;
            }
            list.slick({
            ...
            prev.on('click', function(event) {
                $(this).parents('.hotproduct_list_met_11_2').find('.list').slick('slickPrev');
            });
            next.on('click', function(event) {

                 $(this).parents('.hotproduct_list_met_11_2').find('.list').slick('slickNext');
            });
        }
        var imgs=METUI['hotproduct_list_met_11_2'].find('.displayimgs');
        imgs.slick({
                lazyLoad: 'progressive',
                slidesToShow: 1,
                slidesToScroll: 1,
...
var x = new metui(METUI_FUN['hotproduct_list_met_11_2']);