		...
		setTimeout(function(){
			...
			var demoFun=function(id){
				if(demo_iframe=='iframe-min'){// 有固定定位元素则导航最小化
					...
					$iframe_css.innerHTML='.demo-iframe{-webkit-transition: all .5s;-o-transition: all .5s;transition: all .5s;}.demo-iframe.iframe-min{left: -100% !important;-webkit-transform: translate(163px,0);-ms-transform: translate(163px,0);-o-transform: translate(163px,0);transform: translate(163px,0);}';
				...
				$demo_iframe_load.style='width: 100%;height: 50px;position: fixed;left: 0;top: 0;z-index: 9999998;background:#000;text-align:center;font-size:16px;color:#999;line-height:50px;';
				if(demo_iframe=='iframe-min') $demo_iframe_load.style.width='163px';
				...
				$demo_iframe.style='width: 100%;height: 50px;position: fixed;left: 0;top: 0;z-index: 9999999;display:none';
