...
(function($){
	 ...
	 $(window).resize(function(){
		...
		setTimeout(function(){
			var $bd = $('.bd').width();
			 $('.bd .tempWrap,.con').width($bd);
		},425)
		
		$('.conWrap').css({'left':0})
		$('.hd ul li').removeClass('on');
        $('.about').addClass('on');
        $('.left_zz,.right_zz').removeClass('current');
        $('.zz').fadeOut();		
	 }) 
			...
			if(opts.trigger=="mouseover"){
				...
				//doPlay(); 
				    if(index == 0){
					   var $bd = $('.bd').width();
					   //$('.conWrap').css({'left':-$bd})
					   $('.conWrap').stop(true,true).animate({"left":0},500)
				   }	
                   if(index == 1){
					   var $bd = $('.bd').width();
					   //$('.conWrap').css({'left':-$bd})
					   $('.conWrap').stop(true,true).animate({"left":-$bd},500)
				   }
                   if(index == 2){
					   var $bd = $('.bd').width();
					   //$('.conWrap').css({'left':-$bd})
					   $('.conWrap').stop(true,true).animate({"left":-($bd*2)},500)
				   }				 	   
			  	   //doPlay(); 
				}) 
